...
#define CLIENT1_H
/////////////////////////////////////////////////////////////////////////
// Client1.h - Used for testing concurrent communication, representing //
...
public:
	//-----------< constructor >---------------------------------------------------- ----------------------
	Client1(size_t port = 9080, Socket::IpVer ipv = Socket::IP6, int qNum = 3) : r(Receiver(port, ipv, 3, s)){};
